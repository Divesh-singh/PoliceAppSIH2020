            ...
            <ImageBackground source={require('../assets/Back.jpg')} style={{width: '100%', height: '100%'}}>
                ...
                <View>
                 ...
                 <Header
                    ...
                    centerComponent={{ text: 'Beat Management', style: { color: "#1C8ADB",fontWeight:'bold',fontSize:22,letterSpacing:3 } }}
              ...
              <View style={styles.container}>
                <ScrollView>
                  <TouchableOpacity onPress={()=>this.props.navigation.navigate("Elder")}>
                    <View style={styles.tab} >
                      <Text  style={styles.item} >Elderly Management</Text>
                    ...
                    <TouchableOpacity>
                    <View  style={styles.tab}>
                      <Text style={styles.item}>Contact Area Beat Officers</Text>
