...
export default class ElderlyManagementView extends Component {
  ...
  fetchDataUser = () => {
    firebase
      .database()
      .ref("crimeRecord/-M-ExS3dV5-tYelvPNpE")
      .on("value", snapshot => {
        data = snapshot.val();
  ...
  fetchDataUser2 = () => {
    firebase
      .database()
      .ref("crimeRecord/-M-Ey4s1WMLLSTN4rOwg")
      .on("value", snapshot => {
        data = snapshot.val();
        keys = Object.keys(data);
        dat= Object.values(data);
  ...
  fetchDataUser3 = () => {
    firebase
      .database()
      .ref("crimeRecord/-M-EyIQs9HhE3dZEJrly")
      .on("value", snapshot => {
        data = snapshot.val();
        keys = Object.keys(data);
        dat= Object.values(data);
        ...
        <Header
          ...
          rightComponent={{
            ...
            onPress: () =>
              Alert.alert(
                "INFO",
                "Crime Records Fetched From Database.\n"
              )
          }}
        ...
        <View style={styles.container}>
          <ScrollView>
            ...
            <Card style={{ padding: 10, margin: 10 }}>
              ...
              <Text style={styles.text}>{key2[3]}:{" "}{User[3]}</Text>
